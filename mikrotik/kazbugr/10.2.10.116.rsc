/interface vlan
add interface=ether1 loop-protect-disable-time=0s name=ether1.2014 vlan-id=2014
...
add address=10.2.10.116/24 interface=ether1.2014 network=10.2.10.0
...
add area-id=0.0.0.9 default-cost=1 inject-summary-lsas=yes name=area9 type=stub
/routing ospf instance
set [ find default=yes ] redistribute-connected=as-type-1 router-id=10.2.10.116
/routing ospf interface
add interface=ether1.2014 network-type=broadcast priority=0
add network-type=broadcast passive=yes
/routing ospf network
add area=area9 network=10.2.10.0/24
add area=area9 network=10.1.0.0/19
add area=area9 network=91.197.76.0/22
