/interface vlan
add interface=ether1 loop-protect-disable-time=0s name=ether1.2015 vlan-id=2015
...
add address=10.2.11.100/24 interface=ether1.2015 network=10.2.11.0
...
add area-id=0.0.0.10 default-cost=1 inject-summary-lsas=yes name=area10 type=stub
/routing ospf instance
set [ find default=yes ] redistribute-connected=as-type-1 router-id=10.2.11.100
/routing ospf interface
add interface=ether1.2015 network-type=broadcast priority=0
add network-type=broadcast passive=yes
/routing ospf network
add area=area10 network=10.2.11.0/24
add area=area10 network=10.1.0.0/19
add area=area10 network=91.197.76.0/22
