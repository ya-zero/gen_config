...
add disabled=no interface=br_vl_BRAS one-session-per-host=yes/routing ospf area
set [ find default=yes ] disabled=yes
add area-id=0.0.0.1 default-cost=1 inject-summary-lsas=yes name=area1 type=stub
/routing ospf instance
set [ find default=yes ] redistribute-connected=as-type-1 router-id=10.2.2.3
