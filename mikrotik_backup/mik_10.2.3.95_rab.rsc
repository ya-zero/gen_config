...
/ip address
add address=10.2.3.95/24 interface=ether1.2008 network=10.2.3.0
...
add area-id=0.0.0.3 default-cost=1 inject-summary-lsas=yes name=area1 type=stub
/routing ospf instance
set [ find default=yes ] redistribute-connected=as-type-1 router-id=10.2.3.95
/routing ospf interface
add interface=ether1.2008 network-type=broadcast priority=0
add network-type=broadcast passive=yes
/routing ospf network
add area=area1 network=10.2.3.0/24
