...
def send_command(host,vlan_id):
      try:
          ...
          client.connect(hostname=host,
                         ...
                         look_for_keys=False,
                         allow_agent=False)
          stdin, stdout, stderr = client.exec_command('/interface brid port remove numbers=[find bridge =br_vl_PPPoE  interface~"ether1"]')
...
sector_replace=['192.168.30.45','192.168.30.46','192.168.30.154','192.168.30.73','192.168.30.145','192.168.30.144','192.168.30.153']
